#-----------------------------------------------------------------------
# <copyright file="Framework-GitHub-WPF.ps1" company="GoodToCode Source">
...
param(
	...
	[String]$ProductName = 'Framework-for-WPF',
...
Copy-SourceCode -Path $BuildFull -RepoName $RepoName -ProductName $ProductName -SubFolder $SubFolder -SolutionFolder $SolutionFolder -Snk GoodToCodeFramework.snk -Relative ($Relative+'..\')
