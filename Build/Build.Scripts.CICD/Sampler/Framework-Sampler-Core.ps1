...
# ***
# WebServices
[String]$PathFull = ($Path + '\_PublishedSites\Framework.WebServices.Core')
[String]$DestinationFull = [String]::Format("{0}\Sites\{1}\{2}-for-WebApi-Core", $Destination, $Domain, $RepoName)
...
# ***
# WebApp
[String]$PathFull = ($Path + '\_PublishedSites\Framework.WebApp.Core')
[String]$DestinationFull = [String]::Format("{0}\Sites\{1}\{2}-for-Mvc-Core", $Destination, $Domain, $RepoName)
Copy-WebSite -Path $PathFull -Destination $DestinationFull
