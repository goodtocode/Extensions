//-----------------------------------------------------------------------
// <copyright file="HttpRequestClient.cs" company="GoodToCode">
...
namespace GoodToCode.Extras.Net
{
    ...
    public abstract class HttpRequestClient : IDisposable
    {
        ...
        /// Raw data received
        /// </summary>
        public string DataReceivedRaw { get; set; } = Defaults.String;

        /// <summary>
        /// DataReceivedRaw value decrypted
        /// </summary>
        public string DataReceivedDecrypted { get; set; } = Defaults.String;
        ...
        /// Url of request
        /// </summary>
        public Uri Url { get; protected set; } = Defaults.Uri;

        /// <summary>
        /// Specify if want to send plain text with no alterations
        /// </summary>
        public bool SendPlainText { get; protected set; } = Defaults.Boolean;

        /// <summary>
        /// Specify if want to send plain text with no alterations
        /// </summary>
        public bool ThrowExceptionWithEmptyReponse { get; set; } = Defaults.Boolean;
