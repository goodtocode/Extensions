...
namespace GoodToCode.Extras.Web.Http
{
    ...
    public struct RouteMapping
    {
        ...
        public struct Mappings
        {
            ...
            /// </summary>
            public static RouteMapping WebApiDefault = new RouteMapping("DefaulApi", "api/{controller}/{id}");

            /// <summary>
            /// DefaulApiV1: v1/{controller}/{id}
            /// </summary>
            public static RouteMapping WebApiV1 = new RouteMapping("DefaulV1", "v1/{controller}/{id}");
            ...
            /// DefaulApi: api/{controller}/{id}
            /// </summary>
            public static RouteMapping MvcDefault = new RouteMapping("Default", "{controller}/{action}/{id}", new { controller = "Home", action = "Index" });
        }
        ...
        public RouteMapping(string name, string routeTemplate)
        {
            Name = name;
            RouteTemplate = routeTemplate;
            Defaults = Extensions.Defaults.String;
        }
        ...
        public RouteMapping(string name, string routeTemplate, object defaults) : this(name, routeTemplate)
        {
            Defaults = defaults;
        }
    }
