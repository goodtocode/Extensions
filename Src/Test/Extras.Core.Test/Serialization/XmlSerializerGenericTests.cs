//-----------------------------------------------------------------------
// <copyright file="XMLSerializerGenericTests.cs" company="GoodToCode">
...
{
    [TestClass()]
    public class XMLSerializerGenericTests
    {
        ...
        [TestMethod()]
        public void Core_Serialization_XmlGeneric_Serialize()
        {
        ...
        [TestMethod()]
        public void Core_Serialization_XmlGeneric_Deserialize()
        {
            var serializer = new XmlSerializer<MyClass>();
