//-----------------------------------------------------------------------
// <copyright file="ObjectExtensionTests.cs" company="GoodToCode">
...
namespace GoodToCode.Extensions.Test
{
    ...
    public class ObjectExtensionTests
    {
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Object_CastSafe()
        {
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Object_CastOrFill()
        {
            var testItem = new MyClass1();
            var compareItem = new MyClass3();
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Object_NameRuntime()
        {
            var testItem = new MyClass1();
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Object_NameCompiletime()
        {
            var testItem = new MyClass1();
            var otherItem = new MyClass3();
