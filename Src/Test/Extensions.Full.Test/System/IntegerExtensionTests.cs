//-----------------------------------------------------------------------
// <copyright file="IntegerExtensionTests.cs" company="GoodToCode">
...
namespace GoodToCode.Extensions.Test
{
    ...
    {
        [TestMethod()]
        public void Full_Integer_ToDecimal()
        {
            var testItem = 10;
        ...
        [TestMethod()]
        public void Full_Integer_ToGuid()
        {
        ...
        [TestMethod()]
        public void Full_Integer_Negate()
        {
            var testItem = 10;
