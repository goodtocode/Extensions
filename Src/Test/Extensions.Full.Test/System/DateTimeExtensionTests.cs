//-----------------------------------------------------------------------
// <copyright file="DateTimeExtensionTests.cs" company="GoodToCode">
...
{   
    ...
    {
        [TestMethod()]
        public void Full_DateTime_ISO8601_FormatStrings()
        {
        ...
        [TestMethod()]
        public void Full_DateTime_Tomorrow()
        {
        ...
        [TestMethod()]
        public void Full_DateTime_Yesterday()
        {
            var date = DateTime.Now;
        ...
        [TestMethod()]
        public void Full_DateTime_FirstDayOfMonth()
        {
        ...
        [TestMethod()]
        public void Full_DateTime_LastDayOfMonth()
        {
            var date = new DateTime(2016, 8, 15);
        ...
        [TestMethod()]
        public void Full_DateTime_IsSavable()
        {
