...
namespace Genesys.Extras.Test
{
    ...
    public class JsonSerializerGenericTests
    {
        ...
        [TestMethod()]
        public void Portable_Serialization_Json_ValueTypes()
        {
        ...
        [TestMethod()]
        public void Portable_Serialization_Json_ReferenceTypes()
        {
            // Collections, etc
        ...
        [TestMethod()]
        public void Portable_Serialization_Json_PersonInfo()
        {
            // Collections, etc
        ...
        [TestMethod()]
        public void Portable_Serialization_Json_String()
        {
        ...
        [TestMethod()]
        public void Portable_Serialization_Json_StringMutable()
        {
        ...
        [TestMethod()]
        public void Portable_Serialization_Json_StringToStringMutable()
        {
            StringMutable testPhraseMutable = testPhrase;
            var result = TypeExtension.DefaultString;
            StringMutable resultMutable = TypeExtension.DefaultString;
