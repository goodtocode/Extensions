//-----------------------------------------------------------------------
// <copyright file="UrlBuilderTests.cs" company="GoodToCode">
...
namespace GoodToCode.Extras.Test
{
    ...
    public class UrlBuilderTests
    {
        ...
        [TestMethod()]
        public void Full_Net_UrlBuilder()
        {
        ...
        [TestMethod()]
        public void Full_Net_UrlBuilder_ParameterBinding()
        {
        ...
        [TestMethod()]
        public void Full_Net_UrlBuilder_Querystring()
        {
        ...
        [TestMethod()]
        public void Full_Net_UrlBuilder_ToString()
        {
        ...
        [TestMethod()]
        public void Full_Net_UrlBuilder_Encode()
        {
            Assert.IsTrue(UrlBuilder.Encode("@Test") == "%40Test", "Encode failed");
        }

        [TestMethod()]
        public void Full_Net_UrlBuilder_Decode()
        {
