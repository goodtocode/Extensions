...
namespace GoodToCode.Extras.Test
{
    ...
    {
        [TestMethod()]
        public void Full_Collections_KeyValueList_Construct()
        {
        ...
        [TestMethod()]
        public void Full_Collections_KeyValueList_Add()
        {
            var kvList = new KeyValueList<int, int>();
        ...
        [TestMethod()]
        public void Full_Collections_KeyValueList_Remove()
        {
        ...
        [TestMethod()]
        public void Full_Collections_KeyValueList_GetValue()
        {
            var kvList = new KeyValueList<int, double>();
            kvList.Add(1, 100.00);
            kvList.Add(2, 200.00);
        ...
        [TestMethod()]
        public void Full_Collections_KeyValueList_ToString()
        {
