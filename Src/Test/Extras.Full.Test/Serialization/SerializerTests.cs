//-----------------------------------------------------------------------
// <copyright file="SerializerTests.cs" company="GoodToCode">
...
namespace GoodToCode.Extras.Test
{
    ...
    {
        [TestMethod()]
        public void Full_Serialization_Serializer_ValueTypes()
        {
        ...
        [TestMethod()]
        public void Full_Serialization_Serializer_ReferenceTypes()
        {
            // Collections, etc
