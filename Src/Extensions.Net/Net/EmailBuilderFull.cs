...
namespace GoodToCode.Extensions.Net
{
    ...
    public class EmailBuilder
    {
        ...
        public class FooterLegal
        {
            ...
            /// PublishFooter
            /// </summary>
            public bool PublishFooter { get; set; } = false;
            /// <summary>
            /// ToEmailAddress
            /// </summary>
            public string ToEmailAddress { get; set; } = string.Empty; // 0
            /// <summary>
            /// CompanyFriendlyName
            /// </summary>
            public string CompanyFriendlyName { get; set; } = string.Empty; // 1
            /// <summary>
            /// UnsubscribeURL
            /// </summary>
            public string UnsubscribeURL { get; set; } = string.Empty; // 2
            /// <summary>
            /// CompanyLegalName
            /// </summary>
            public string CompanyLegalName { get; set; } = string.Empty; // 3
            /// <summary>
            /// Address
            /// </summary>
        ...
        public KeyValuePair<string, bool> Send(string mailToAddresses, string title, string contents, FooterLegal legal, char addressseparator = ';')
        {
            ...
            returnValue = Send(mailTo, title, contents, legal, SendCompletedCallback, string.Empty);
