//-----------------------------------------------------------------------
// <copyright file="XmlInvalidCharacterCleanser.cs" company="GoodToCode">
...
namespace GoodToCode.Extensions.Text.Cleansing
{
    ...
    public class XmlInvalidCharacterCleanser : Cleanser
    {
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public XmlInvalidCharacterCleanser() : base() { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="textToCleanse">Plain text to have characters cleansed</param>
        public XmlInvalidCharacterCleanser(string textToCleanse)
            : this()
        {
